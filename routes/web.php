...
Route::get(
    '/berita',
    [PublicPostController::class, 'news']
)->name('public.news');

Route::get(
    '/berita/{slug}',
    [PublicPostController::class, 'newsShow']
)->name('public.news.show');

// Route::get(
//     '/pengumuman',
//     [PublicPostController::class, 'announcements']
// )->name('public.announcements');

// Route::get(
//     '/pengumuman/{slug}',
//     [PublicPostController::class, 'announcementShow']
// )->name('public.announcements.show');

Route::get(
    '/regulasi',
    [PublicPostController::class, 'regulations']
)->name('public.regulations');

Route::get(
    '/regulasi/{slug}',
    [PublicPostController::class, 'regulationShow']
)->name('public.regulations.show');

Route::get(
    '/pencarian',
    [PublicPostController::class, 'search']
)->name('public.search');
...
|--------------------------------------------------------------------------
|
| Preview dan download dokumen regulasi dapat diakses
| oleh masyarakat tanpa login.
|
*/
...
Route::middleware('auth')->group(function () {
    Route::get(
        '/helpdesk/tiket-saya',
        [PublicHelpdeskController::class, 'myTickets']
...
Route::post(
    '/helpdesk/tiket/kirim-ulang-akses',
    [PublicHelpdeskController::class, 'resendTicketAccess']
)
    ->middleware('throttle:5,1')
    ->name('helpdesk.ticket.resend-access');

Route::get(
    '/helpdesk/tiket/akses',
    [PublicHelpdeskController::class, 'ticketAccess']
)->name('helpdesk.ticket.access');

Route::get(
    '/helpdesk/tiket/{ticketNumber}/attachment/{attachment}/view',
    [PublicHelpdeskController::class, 'viewAttachment']
)->name('helpdesk.ticket.attachment.view');
...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    Route::get(
        '/akun',
        [PublicAccountController::class, 'edit']
    )->name('public.account.edit');

    Route::patch(
        '/akun',
        [PublicAccountController::class, 'update']
